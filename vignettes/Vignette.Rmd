---
title: "Using bodycompref"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using bodycompref}
  %\VignetteEngine{knitr::rmarkdown}
  \usepackage[utf8]{inputenc}
---

# Using bodycomprefdata
...
install.packages("adiposerefdata", repos="https://yourname.github.io/drat")
# Models for skeletal muscle, ~45Mb
install.packages("musclerefdata", repos="https://yourname.github.io/drat")
```
...
+ percentile: Anumeric (vector), percentile to return value for. If both percentile and z_score are given, only percentile is evaluated
...
# Actual calculation
percent_predicted(metric, sex, level, age, measurement)
```
